  ...
  return (
    <div className="w-full h-[80px] flex items-center justify-between md:justify-center gap-[30px] px-[20px] fixed top-0 z-[9999] bg-gradient-to-r from-orange-50 via-red-50 to-pink-50 backdrop-blur-xl border-b border-white/20 shadow-lg overflow-visible">
      ...
      <div className="transform hover:scale-110 transition-all duration-300 cursor-pointer">
        <h1 className="text-3xl font-bold bg-gradient-to-r from-[#ff4d2d] to-orange-600 bg-clip-text text-transparent drop-shadow-sm"
        onClick={() => navigate("/")}
        >
          Vingo
        </h1>
      ...
      <div className="flex items-center gap-[12px]">
        ...
        {userData.role == "user" && (
          <div className="relative cursor-pointer group">
            <div className="w-[45px] h-[45px] bg-white/80 backdrop-blur-sm rounded-full shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-300 flex items-center justify-center border border-white/20"
        ...
        {userData.role == "owner" ? (
          <>
            ...
            {/* Orders Button */}
            <div className="hidden md:flex items-center gap-2 cursor-pointer relative px-4 py-2 rounded-xl bg-white/80 backdrop-blur-sm text-[#ff4d2d] font-semibold border-2 border-[#ff4d2d]/50 hover:bg-[#ff4d2d] hover:text-white transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl group"
